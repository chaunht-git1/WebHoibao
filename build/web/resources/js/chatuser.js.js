 ...
 // Ket noi .  
                ...
                //alert(user);
                // socket =  new WebSocket("ws://emoney-in.dongamoneytransfer.com.vn/EmoneyMobileOut/chat?"+ user');
               // var socket = new WebSocket('ws://emoney-in.dongamoneytransfer.com.vn/EmoneyMobileOut/chat?'+ user);
...
function createNewChat(sender, message) {
    ...
    var d = new Date();
    var hh = d.getHours()+":"+d.getMinutes()+":"+d.getSeconds();
    
    

    if(sender === usernameInputEl.value)
        sender =usernameInputEl.value+"("+ hh+") :";
