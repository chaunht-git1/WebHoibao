...
public class CreateMapImageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      //  String imageUrlString = "http://emoney-in.dongamoneytransfer.com.vn/PQcodeExplem/qrservlet?qrtext="+id;
        String imageUrlString = "https://maps.googleapis.com/maps/api/staticmap?center="+id+"&zoom=17&size=800x600&maptype=roadmap&markers=color:red%7Clabel:A%7C"+id+"&key=AIzaSyDLSiZPw0DhzOLGQSeT6PhWYTkyH8LWq6g";
         // Read the image ...
